...
I defer the proof to [Harris's textboo](https://www.rand.org/content/dam/rand/pubs/reports/2009/R381.pdf) and
solve for the largest eigenvalue of our mean matrix.
```{r}
